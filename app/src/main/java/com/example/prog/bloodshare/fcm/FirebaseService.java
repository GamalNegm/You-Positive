package com.example.prog.bloodshare.fcm;
...
import com.example.prog.bloodshare.Activities.ChatActivity;
...
public class FirebaseService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getData().size() > 0) {
            ...
            Log.e("message content", remoteMessage.getData().get("content"));
    ...
    private void sendNotification(Message message) {
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(this)
                .setSmallIcon(R.mipmap.ic_chat_room)
                .setContentTitle("BLoodShare")
